...
def populate():
    python_pages = [
        {"title": "Official Python Tutorial", "url": "http://docs.python.org/2/tutorial/", "views": 120},
    ...
    other_pages = [{"title": "Bottle", "url": "http://bottlepy.org/docs/dev/", "views": 100},
                   {"title": "Flask", "url": "http://flask.pocoo.org", "views": 65}]
